...
class SendEmailTests(TestCase):
    ...
    def test_sends_one_email(self):
        make_template()
        send_email("test", recipient_list=["recipient@example.com"])
    ...
    def test_from_email_is_passed_through(self):
        make_template()
        send_email("test", recipient_list=["r@example.com"], from_email="sender@example.com")
    ...
    def test_raises_for_unknown_template(self):
        with self.assertRaises(EmailTemplate.DoesNotExist):
            send_email("does-not-exist", recipient_list=["r@example.com"])

    def test_sends_to_multiple_recipients(self):
        make_template()
        send_email("test", recipient_list=["a@example.com", "b@example.com"])
